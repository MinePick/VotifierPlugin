...
public class ProxyForwardingVoteSource implements ForwardingVoteSource {
    ...
    public ProxyForwardingVoteSource(VotifierPluginInterface plugin, Supplier<Bootstrap> nettyBootstrap, List<BackendServer> backendServers, VoteCache voteCache) {
        this.plugin = plugin;
